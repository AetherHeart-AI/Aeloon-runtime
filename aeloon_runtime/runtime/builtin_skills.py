"""Provision the skills bundled with the Aeloon Runtime distribution."""
...
BUILTIN_SKILL_IDS = ("aeloon-office-lite",)
...
def provision_builtin_skills(data_dir: Path | str) -> tuple[str, ...]:
    ...
    source_root = files("aeloon_runtime.resources").joinpath("skills")
