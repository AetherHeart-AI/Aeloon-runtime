...
from aeloon_runtime.rpc.adapter import AeloonRpcAdapter
from aeloon_runtime.rpc.protocol import MAX_FRAME_BYTES, RpcError
...
class RpcConnection:
    ...
    async def _handle(self, request: Any) -> None:
        ...
        try:
            ...
            error = RpcError("internal_error", "Aeloon Runtime could not complete the request")
