...
```bash
aeloon-runtime system skill aeloon-office-lite ACTION ...
```
...
```bash
aeloon-runtime system skill aeloon-office-lite preflight
aeloon-runtime system skill aeloon-office-lite read input.pdf --output extracted.md
aeloon-runtime system skill aeloon-office-lite write content.json output.docx
aeloon-runtime system skill aeloon-office-lite validate output.docx
aeloon-runtime system skill aeloon-office-lite render output.pptx --output-dir rendered
```
