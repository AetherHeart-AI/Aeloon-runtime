...
export const COMMANDS: CommandDefinition[] = [
  ...
  { name: "profiles", usage: "/profiles", description: "List active Worker profiles" },
  { name: "spawn", usage: "/spawn <profile> <task>", description: "Spawn a Worker" },
  { name: "cancel", usage: "/cancel [run]", description: "Cancel the selected Worker" },
  {
    name: "resume-worker",
    usage: "/resume-worker [instruction…]",
    description: "Continue or recover the selected Worker",
  },
