"""Stable system and orchestration prompts for the Master agent."""
...
def master_system_prompt(
    *,
    role_descriptors: list[dict[str, Any]],
    ...
    return (
        ...
        + json.dumps(role_descriptors, ensure_ascii=False, sort_keys=True)
    )
